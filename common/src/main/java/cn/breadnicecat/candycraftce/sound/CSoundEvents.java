...
public class CSoundEvents {
	...
	public static final SoundEntry GUMMY_BALL_THROW = register("gummy_ball_throw");
	public static final SoundEntry GUMMY_BALL_HEAVY_THROW = register("gummy_ball_heavy_throw");
